...
parser.add_argument('--gamma', type=float, default=0.98, help='Huber loss delta')
...
class EarlyStoppingWithMA:
    def __init__(self, patience=10, verbose=False, delta=0.005, path='checkpoint-rosy-bird-2.pt', trace_func=print, ma_window=10):
